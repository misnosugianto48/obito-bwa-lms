                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center gap-3">
                                                <div class="flex w-[50px] h-[50px] shrink-0 rounded-full overflow-hidden">
                                                    <img src="{{ Storage::url($mentor->user->photo) }}"
                                                        class="w-full h-full object-cover" alt="photo">
                                                </div>
                                                <div>
                                                    <p class="font-semibold">{{ $mentor->user->name }}</p>
                    ...
                    <div id="lessons-content" class="tab-content flex flex-col gap-5 w-full max-w-[650px] hidden">
                        ...
                        @foreach ($course->courseSections as $section)
                            <div
                                ...
                                <button type="button" id="accordion-btn"
                                    data-expand="{{ $section->course_section_id }}"
                                ...
                                <div id="{{ $section->course_section_id }}" class="">
                                    <div class="flex flex-col gap-4">
