       ...
       @section('title', 'Obito - Finished Course')
       @section('content')
           <div class="relative flex justify-center">
               ...
               <main
                   ...
                   <div class="mx-auto flex w-[500px] flex-col gap-[10px] items-center">
                       <h1 class="text-center font-bold text-[28px] leading-[42px]">What a Day! Now<br>You’re Ready to Work
                       </h1>
                       <p class="text-center text-obito-text-secondary leading-[28px]">Anda telah menyelesaikan materi
                           kelas dengan baik selanjutnya dapat membuat portfolio dan mengikuti magang</p>
                   </div>
                   <div id="card"
                       ...
                       <div class="flex flex-col gap-[10px]">
                           ...
                           <div class="flex items-center gap-[6px]">
                               <img src="{{ asset('assets/images/icons/menu-board-green.svg') }}" alt="icon"
                                   class="size-5 shrink-0" />
                               <p class="text-sm leading-[21px] text-obito-text-secondary">{{ $course->content_count }}
                                   Lessons</p>
                           </div>
                       </div>
                   </div>
